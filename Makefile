...
docs: docs/busyserve.1.md docs/busyserve.1.md

docs/busyserve.1.md:
	@typer $(TARGET).__main__ utils docs --name busyserve --output $@
	@sed -i '' -e  "s///g" $@
...
report:
	pytest --cov=./busyserve --cov-report=html
